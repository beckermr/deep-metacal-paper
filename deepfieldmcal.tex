...
\begin{abstract}
    ...
    signals by using a deeper imaging survey for
    ...
    deep-field \mcal, which we attribute primarily to the increased source
...
of the galaxy $G$ is convolved by a PSF $P$ giving $G\star P$, and has additional noise
which results in $G\star P + N$.
...
lower noise than standard \mcal. The average increase in signal-to-noise per object
will result in weak lensing samples from deep-field \mcal that extend to higher redshift
than those from standard \mcal. We leave estimating the amplitude and significance of
